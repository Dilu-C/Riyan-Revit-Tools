        ...
        <Grid>
            ...
            <Border x:Name="HeaderBar" Grid.Row="0" Background="#1A1A1A">
                <Grid Margin="10,0">
                    ...
                    <Button x:Name="Btn_Close" Content="x" HorizontalAlignment="Right" Background="Transparent" Foreground="White" BorderThickness="0" FontSize="18" VerticalAlignment="Center"/>
                </Grid>
            </Border>
...
class ConnectionWindow(WPF.Window):
    def __init__(self, main_element, intersecting_elements, connection_types):
        ...
        self._apply_highlight([main_element.Id], create_color(0, 200, 80), is_main=True)
    ...
    def _refresh_child_highlights(self):
        ...
        try:
            ...
            if to_highlight:
                self._apply_highlight(to_highlight, create_color(220, 50, 50))
            if to_clear:
    ...
    def OnChildChecked(self, sender, args):
        ...
        try:
            ...
            if toggled_cb.IsChecked == True:
                self._apply_highlight([el.Id], create_color(220, 50, 50))
            else:
...
if __name__ == "__main__":
    try:
        ...
        forms.alert(traceback.format_exc(), title="Smart Connect Error")
